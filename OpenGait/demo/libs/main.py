...
def main():
    ...
    writeresult(gallery_probe1_result, probe1_video_path, video_save_folder,os.path.splitext(os.path.basename(gallery_video_name))[0])
    writeresult(gallery_probe2_result, probe2_video_path, video_save_folder,os.path.splitext(os.path.basename(gallery_video_name))[0])
    writeresult(gallery_probe3_result, probe3_video_path, video_save_folder,os.path.splitext(os.path.basename(gallery_video_name))[0])
    writeresult(gallery_probe4_result, probe4_video_path, video_save_folder,os.path.splitext(os.path.basename(gallery_video_name))[0])
